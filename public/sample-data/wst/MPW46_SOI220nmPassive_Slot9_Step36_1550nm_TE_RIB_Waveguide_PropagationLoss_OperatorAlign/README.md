# MPW46_SOI220nmPassive_Slot9_Step36_1550nm_TE_RIB_Waveguide_PropagationLoss_OperatorAlign
This folder contains GitHub-hosted measurement traces for MPW46.
## Dataset Summary
- Project: MPW46
- Wafer: Slot9
...
- Files: 42
- Chips: Chip37, Chip40, Chip46, Chip49, Chip52, Chip61, Chip64
- Waveguides: WG1, WG2, WG3, WG4, WG5, WG6
- Metadata: metadata.json
- Route config: route-config.json
- Filename manifest: filename-manifest.csv
- Publisher: CORNERSTONE
- License: Pending
- Normalized rows: 798042
